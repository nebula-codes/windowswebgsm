...
namespace windowswebgsm.data.Logic
{
    ...
    {
        private readonly string _exeFile = "steamcmd.exe";
        ...
        public SteamCMD()
        {
            ...
            _installPath = helper.GetSteamBin();
            _userDataPath = helper.GetSteamUserData();
        ...
        public string GetParameter(string forceInstallDir, string appId, bool validate = true, bool loginAnonymous = true, string modName = null, string custom = null)
        {
            ...
            {
                var (username, password) = this.GetSteamUsernamePassword();
        ...
        // New parameter script
        private (string?, string?) GetSteamUsernamePassword()
        {
